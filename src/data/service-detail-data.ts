...
export const servicePages: ServicePageData[] = [
  {
    ...
    extendedParagraphs: [
      ...
      "We design and deploy IT infrastructure for growing businesses — servers, storage, networking, and workstations — sized to your team, using vendor-agnostic hardware recommendations, enterprise-grade physical installation, and thorough post-deployment documentation. We work with Tier-1 vendors — HP, Dell, Cisco, Netgear, Synology, and Lenovo — and procure at commercial pricing that typically undercuts direct retail by 15–25%.",
  ...
  },
  {
    ...
    extendedParagraphs: [
      ...
      "Alentro's IT consulting practice is led by founders with direct experience in IT/tech operations, business consulting, and systems design — not generic frameworks, but hands-on knowledge of what works at SME scale in India.",
